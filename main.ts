...
class StringManipulate implements StringManipulationService
{
...
class NumberManipulate implements NumberManipulationService {
...
let num1: number;
num1=23;
let str_manipulation = new StringManipulate();
let num_manipulation = new NumberManipulate();
